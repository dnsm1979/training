...
#         return
#     elif choice == 1:
#         return add_number_to_user_list(int(input('введите число для добавления в список: ')))
#     elif choice == 2:
#         return del_all_number_in_user_list(int(input('введите число для удаления из списка: ')))
#     elif choice == 3:
#         return show_sub_menu()
#     elif choice == 4:
#         number_check = int(input('введите число для поиска в списке: '))
#         if check_number_in_user_list(number_check) == True:
#             print(f'{number_check} есть списке!')
#         else:
#             print(f'{number_check} нет в списке!')
#         return start_menu()
#
#
#     elif choice == 5:
#         return replace_sub_menu()
#     else:
...
#     return start_menu()
#
# def add_number_to_user_list(number):
#     if number is user_list:
...
#         return start_menu()
#
# def del_number_in_user_list(number):
#     if check_number_in_user_list(number) == True:
#         for i in range(len(user_list)):
#             if user_list[i] == number:
#                 user_list.pop(user_list[i])
#                 print(f'Первое попавшееся число {number} удалено из списка!')
#                 return start_menu()
#     print(f'Числа {number} нет в списке!')
#     return start_menu()
#
# def del_all_number_in_user_list(number):
#     if check_number_in_user_list(number) == True:
#         for i in user_list:
#             if i == number:
#                 user_list.remove(i)
...
#
#
# def check_number_in_user_list(number):
#     # count = 0
#     # for i in user_list:
#     #     if i == number:
#     #         count += 1
#     # print(f'{number} встречается в списке {count} раз!')
#     # return start_menu()
