...
while True:
    choice = int(
        input(
            f"1-Добавление исполнителя и альбома в словарь\n"
    ...
    if choice == 1:
        ...
        edit_key_dict_performer(
            input("Редактируемое название исполнителя: "), input("Новое название: ")
        )
    elif choice == 5:
        edit_value_dict_performer(
            input("Редактируемое название альбома: "), input("Новое название: ")
        )
    elif choice == 6:
        get_dict_performer()
