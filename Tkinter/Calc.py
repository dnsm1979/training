...
def get_entry_sum():
    ...
    if value1 and value2:
        ...
        tk.Label(root, text=f'результат:{value1}+{value2}={sum}').grid(row=4, column=0, stick='w')
    else:
...
def get_entry_sub():
    ...
    if value1 and value2:
        ...
        tk.Label(root, text=f'результат:{value1}-{value2}={sub}').grid(row=4, column=0, stick='w')
    else:
        tk.Label(root, text=f'Некорретный ввод!').grid(row=4, column=0, stick='w')
...
def get_entry_mult():
    ...
    if value1 and value2:
        ...
        tk.Label(root, text=f'результат:{value1}*{value2}={mult}').grid(row=4, column=0, stick='w')
    else:
        tk.Label(root, text=f'Некорретный ввод!').grid(row=4, column=0, stick='w')
...
def get_entry_div():
    ...
    if value1 and value2:
        ...
        tk.Label(root, text=f'результат:{value1}-{value2}={div}').grid(row=4, column=0, stick='w')
    else:
        tk.Label(root, text=f'Некорретный ввод!').grid(row=4, column=0, stick='w')
